    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regularAlarm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, RegularAlarm.class);
                startActivity(i);
            }
        });
        Button helperBtn = findViewById(R.id.HelperBtn);
        helperBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, Helper.class);
                startActivity(i);
            }
        });
